...
<nav class="sidebar">
	...
	<a href="user_managements.php" class="nav-link"><i class="fas fa-chart-bar"></i>User Management</a>
	<a href="user_requests.php" class="nav-link"><i class="fas fa-chart-bar"></i>User requests</a>
	<a href="admin_settings.php" class="nav-link"><i class="fas fa-chart-bar"></i>Settings</a>
    <a href="logout.php" class="nav-link" style="color:var(--danger); margin-top: 20px;"><i class="fas fa-power-off"></i> Logout</a>
</nav>
...
<div class="overlay" id="modal" onclick="closeModal()">
    <div class="side-panel" onclick="event.stopPropagation()">
        ...
        <button onclick="closeModal()" style="margin-top:auto; background:none; border:1px solid #ddd; padding:10px; border-radius:8px; color:#64748b; cursor:pointer">Close Panel</button>
    </div>
</div>
